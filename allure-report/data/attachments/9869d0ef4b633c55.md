...
Call log:
  - waiting for getByRole('link', { name: /apply now/i }) to be visible
...
- generic [active] [ref=e1]:
  ...
  - iframe [ref=e245]:
    - generic [active] [ref=f13e1]:
      - region "Chat Widget" [ref=f13e3]:
        - text:    Enter your message... 
        - complementary "Chat widget launcher" [ref=f13e4]:
          - button "Open chat" [ref=f13e5] [cursor=pointer]:
            - button "Minimize widget" [ref=f13e8]:
              - generic [ref=f13e9]: 
            - generic [ref=f13e11]:
              - paragraph [ref=f13e13]: Questions before you apply?
              - button "Start chat" [ref=f13e14]:
                - paragraph [ref=f13e15]: Browse FAQs here
      - iframe
```
